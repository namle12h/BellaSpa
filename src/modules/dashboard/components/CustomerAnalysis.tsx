   ...
   const { data, isLoading } = useCustomerStats(
    ...
    const ageData = [
        {
            ...
            percent: `${Math.round((ageGroups["18-24"] / Object.values(ageGroups).reduce((a, b) => a + b, 0)) * 100)}%`,
            color: "#ec4899"
        },
        {
            label: "25-34",
            value: ageGroups["25-34"],
            percent: `${Math.round((ageGroups["25-34"] / Object.values(ageGroups).reduce((a, b) => a + b, 0)) * 100)}%`,
            color: "#a855f7"
        },
        {
            label: "35-50",
            value: ageGroups["35-50"],
            percent: `${Math.round((ageGroups["35-50"] / Object.values(ageGroups).reduce((a, b) => a + b, 0)) * 100)}%`,
            color: "#3b82f6"
        },
    ...
    const customerData = [
        ...
        },
        {
            ...
            percent: `${Math.round((data.vipCustomers / (data.newCustomers + data.returningCustomers + data.vipCustomers)) * 100)}%`,
            color: "#f43f5e",
            Icon: () => '👑'
        },
    ];
